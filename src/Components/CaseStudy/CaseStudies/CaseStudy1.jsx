    ...
    <div className="mx-auto w-[86=5%] max-w-7xl bg-white px-5 py-10 md:px-40">
      <div>
        ...
        <h1 className="py-8 text-5xl font-semibold leading-snug text-[#303030]">
          Marketplace unlocks $1.6 million in new revenue with on demand sales
          agents
        </h1>
      </div>
      ...
      <div className="case-study-con">
        ...
        <img
          src="https://influx.com/blog/uploads/anonymous-boxhub-case-study-metrics-1.png"
          alt="img"
        />
        <h2>Solution</h2>
        <ul>
          ...
          <li>Verify sales qualified leads</li>
        ...
        <ul>
          ...
          <li>Includes sales management</li>
          <li>Training for sales representatives included</li>
          <li>Includes revenue quality assurance</li>
        ...
        <ul>
          ...
          <li>
            Inbound + outbound lead qualification - phone calls, emails, and
            text
          </li>
          <li>Revenue QA</li>
        </ul>
        <h2>Results</h2>
        <ul>
          <li>Total revenue generated: $1.6+ million over 5 months</li>
