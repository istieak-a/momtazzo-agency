  ...
  return (
    <div className="mx-auto w-[86=5%] max-w-7xl bg-white px-5 py-10 md:px-40">
      ...
      <div className="case-study-con">
        <h2>Addressing Key Challenges: A Comprehensive Approach</h2>
        <p>
          A premier cashback platform, founded on the principle that every click
        ...
        <h3>Digital Attribution</h3>
        <p>
          Consumers interacted with multiple online touchpoints before
          purchasing, challenging the platform’s ability to track transactions
          accurately. Manual receipt reviews were conducted to combat incorrect
          attribution. This process was time-consuming, with an average of 15
          minutes spent reviewing each receipt, and was prone to human error.
        </p>
        <h3>Redemption Flexibility</h3>
        <p>
          Meeting modern consumer expectations for redemption flexibility posed
          a significant challenge. Shoppers preferred to choose how rewards were
          redeemed, and the platform’s limited options, such as boost gift cards
          or direct cash deposits, revealed a gap between consumer expectations
          and offerings. This gap reduced user satisfaction and limited the
          platform’s adaptability to changing market demands.
        </p>
        <h3>Expanding Retailer Network</h3>
        <p>
          The platform aimed to grow its network of partnered retailers by 45%
          to bolster its market presence and diversify shopping options.
          However, the competitive e-commerce landscape presented significant
          partnership development and integration challenges, making the
          expansion complex.
        </p>
        <h3>Reputation Management</h3>
        <p>
          Safeguarding the platform’s reputation in the volatile online review
          environment posed a continuous challenge. With over 500 negative
          reviews each month (20% of all monthly reviews), the company had to
          proactively manage and respond to user feedback to maintain a positive
          online presence. This relentless battle to uphold its reputation
          highlighted the need for a strategic approach to review management and
          customer engagement.
        </p>
        <p>
        ...
        <h2>Strategic Solutions and Key Outcomes</h2>
        <img
          src="https://hugoinc.com/wp-content/uploads/2024/04/Group-862.png"
          alt="CHART"
        />
        ...
        <p>
          ...
          precisely attributed to its corresponding transaction at the
          retailer’s checkout.
        </p>
        <p>
          ...
          allocation, leading to increased consumer satisfaction.
        </p>
        ...
        <p>
          ...
          expanded retailer network and take advantage of the new cashback
          opportunities.
        </p>
        ...
        <h3>Key Results</h3>
        <ul>
          <li>40% increase in user participation across the platform.</li>
          <li>
            99% accuracy in reward attribution, an increase from the previous
            benchmark of 90%.
          </li>
          <li>
            Customer satisfaction (NPS scores) regarding reward accuracy
            improved by 35%.
          </li>
          <li>
            Addition of 1,500+ retailers within 18 months, a 150% increase vs
            45% target.
          </li>
          <li>
            20% growth in user transactions with new retail partners, indicating
            successful integration and user adoption.
          </li>
          <li>
            Re-engaged 25% of previously inactive users, driven by targeted
            email campaigns.
          </li>
          <li>
            ​​Successfully encouraged the submission of 5,000+ Trustpilot
            reviews within 12 months, elevating the platform’s rating from 4.1
            to 4.6.
          </li>
        </ul>
        <h2>Conclusion</h2>
