  ...
  return (
    <div className="mx-auto w-[86=5%] max-w-7xl bg-white px-5 py-10 md:px-40">
      ...
      <div className="case-study-con">
        <p>
          Our client stands at the forefront of technological innovation. For
          over two decades, they have pushed boundaries in search, AI, and
          software – bettering lives through empowering information and
          data-driven solutions.
        </p>
        <h2>The Need for Inclusive Data</h2>
        <p>
          This trailblazing company shoulders great responsibility. How do we
          ensure all groups benefit from life-changing technologies as
          capabilities advance? How can diverse needs and preferences be
          consistently understood?
        </p>
        <p>
          Our partner set ambitious inclusion goals – wanting products that
          resonate across their global user base. However, achieving equitable
          AI requires expansive datasets…and representation gaps persist.
        </p>
        <p>
        ...
        <p>
          As an added advantage, having teams with a grasp of local contexts
          allowed for nimble adaptation to challenges. When pandemic impacts
        ...
        <ul>
          <li>
            Multi-layer QA defenses prevent errors, with automated checks
            supplemented by manual reviews of issues like motion blur.
          </li>
          <li>
            Sensor arrays and capture methods purpose-built for computer vision
            ensure consistent ML-grade inputs.
          </li>
          <li>
            Specialist privacy/consent teams handle identification ethically
            across regions, supporting inclusion with cultural awareness.
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>97% participating acceptance rate</li>
          <li>3-4% opportunity cost, far below 10% goal</li>
        </ul>
        <p>
          But more than metrics is needed to capture the full impact. With new
          voices represented, facial recognition technology will be better
          equipped to see diverse users; experiences will feel more welcoming,
          and friction will fade.
        </p>
        <p>
