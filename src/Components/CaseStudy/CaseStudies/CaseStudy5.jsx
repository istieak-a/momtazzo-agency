  ...
  return (
    <div className="mx-auto w-[86=5%] max-w-7xl bg-white px-5 py-10 md:px-40">
      ...
      <div className="case-study-con">
        <h2>The Challenge: Managing a Surge in Customer Tickets</h2>
        <p>
          A renowned home furnishings company celebrated for its stylish yet
          affordable furniture range faced customer support challenges during a
          highly publicized, online-only product launch. The company’s legacy
          customer service systems could not withstand the surge of demand,
          leading to a backlog of over 6,300 tickets and spotlighting the need
          for a more efficient and responsive customer service framework to
        ...
        <p>
          ...
          customer experience, prompting a need for a strategic overhaul of the
          customer support system.
        </p>
        <p>
          Alicia Campbell, Senior Manager of Customer Relations, recognized the
        ...
        <h2>
          The Solution: Enhancing Customer Support through Multifaceted
          Strategies
        </h2>
        ...
        <p>
          ...
          time while an ancillary team rapidly worked to expand the company’s
          knowledge base with comprehensive product details, assembly
          instructions, and troubleshooting tips.
        </p>
        <h3>
          🔔 Phase II: Implementing Real-Time Engagement and Proactive
          Communication
        </h3>
        <p>
        ...
        <ul>
          <li>
            Ticket Management: Resolved the backlog and closed 27,000+ tickets
            within the first three months.
          </li>
          <li>CSAT Improvement: Achieved a 98% satisfaction rating.</li>
          <li>
            Response Time Reduction: Reduced email response times from over 14
            days to &lt;30 minutes and live chat response times to &lt;30
            seconds.
          </li>
          <li>
            Resolution Efficiency Boost: Enhanced by 30% by deploying
            specialized support teams and focused training programs.
          </li>
          <li>
            Live Chat Adoption: Direct engagement through live chat resolved 27%
            of inquiries, improving support responsiveness.
          </li>
        </ul>
        <h2>Conclusion</h2>
        <p>
