...
const FilipinoBefinits = ({title}) => {
    const cardData = [
        ...
        }, 
        {
            ...
            link: '/why-outsource/why-microsourcing'
        }
    ]
    return (
        <div className='flex px-5 md:px-16 items-center flex-col md:flex-row bg-[#f4fafc] py-10 gap-10'>
            <h1 className='font-outfit text-5xl font-semibold text-center'>What are the benifits of Filipino {title} outsourcing?</h1>
