    ...
    return (
        <div className='bg-[#1c2336] text-white  px-8 md:px-16 py-20 md:py-36'>
            ...
            <div className='md:border-e'>
                <h1 className='font-outfit font-bold text-4xl md:text-5xl hover:underline hover:text-[#63b3bb] duration-300 cursor-pointer'>Build a dedicated team in India</h1>
            </div>
